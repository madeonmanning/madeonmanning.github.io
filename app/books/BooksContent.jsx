  ...
  return (
    <div className="page-section books-page">
        ...
        <section key={item.id} className={`book-item ${index % 2 !== 0 ? 'inverted-layout' : ''}`}>
          ...
          <div className="item-content">
            ...
            <div className="item-details">
              ...
              <a href={item.url} target="_blank" rel="noopener noreferrer" className="book-order-button">Order {item.name}</a>
            </div>
          </div>
        </section>
      ))}
      ...
      <div className="inquiry-call-to-action">
        ...
        <a href="https://madeonmanning.square.site/" target="_blank" rel="noopener noreferrer" className="main-inquiry-button">Order Here</a>
      </div>
